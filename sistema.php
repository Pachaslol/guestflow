<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO usuarios2(nome,email,telefone,sexo,data_nasc,cidade,estado) 
        VALUES ('$nome','$email','$telefone','$sexo','$data_nasc','$cidade','$estado')");
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM usuarios2 WHERE id LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' ORDER BY id DESC";
    }
    else
    {
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">GuestFlow</a>
    ...
    <div class="box">
        <form action="sistema.php" method="POST">
            <fieldset>
                <legend><b>Fórmulário de Convidados</b></legend>
                <br><br>
                <div class="inputBox">
